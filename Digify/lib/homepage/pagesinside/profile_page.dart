...
class _ProfilePageState extends State<ProfilePage> {
  ...
  Future<void> _loadUserData() async {
    ...
    if (user != null) {
      final userData = await _userViewModel.fetchUserData(user.uid);
      setState(() {
        _userData = userData;
        _isLoading = false;
  ...
  Future<void> _updateAbout(String newAbout) async {
    try {
      ...
      if (user != null && _userData != null) {
        ...
        final updatedUserData = _userData!.copyWith(aboutyou: newAbout);

        // Update in Firebase
        await _userViewModel.updateUserData(updatedUserData);
                      ...
                      child: Column(
                        children: [
                          ...
                          _buildInfoCard(
                            ...
                            [
                              _buildDocumentRow(
                                  'CNIC Front', _userData?.cnicFrontUrl),
                              _buildDocumentRow(
                                  'CNIC Back', _userData?.cnicBackUrl),
                              _buildDocumentRow(
                                  'Signature', _userData?.signaturePicUrl),
                            ],
                          ),
                        ],
                      ),
    ...
    return Padding(
      ...
      child: Row(
        children: [
          ...
          if (url != null)
            IconButton(
              icon: const Icon(Icons.visibility, color: AppColors.primaryGreen),
              onPressed: () {
