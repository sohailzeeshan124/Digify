...
class CertificateQRScannerScreen extends StatefulWidget {
  const CertificateQRScannerScreen({super.key});

  @override
  State<CertificateQRScannerScreen> createState() =>
      _CertificateQRScannerScreenState();
}

class _CertificateQRScannerScreenState
    extends State<CertificateQRScannerScreen> {
  String? scannedData;
  ...
  void _showResultDialog(String data) async {
    ...
    final certificate = await _certificateViewModel.getCertificate(data);
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: Row(
                  children: [
                    const Icon(Icons.verified, color: Color(0xFF274A31)),
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            'Created: ${DateFormat('MMM dd, yyyy').format(certificate.createdAt)}',
                            style: TextStyle(
              ...
              Container(
                ...
                child: Row(
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        'Certificate ID: ${certificate.docId}',
              ...
              Container(
                ...
                child: ListView.builder(
                  shrinkWrap: true,
                  itemCount: certificate.signedBy.length,
                  itemBuilder: (context, index) {
                    final signer = certificate.signedBy[index];
                    return Container(
