...
class _ArchivePageState extends State<ArchivePage> {
  ...
  Future<void> _shareDocument(String path) async {
    try {
      await Share.shareXFiles([XFile(path)], text: 'Check out this file!');
    } catch (e) {
  ...
  Future<void> _deleteLocalFile(
      FileSystemEntity file, Function reloadCallback) async {
    try {
                                        ...
                                        confirmDismiss: (direction) async {
                                          if (direction ==
                                            ...
                                            return false;
                                              ...
                                              DismissDirection.startToEnd) {
                                            await _shareDocument(file.path);
                                            return false;
                                          }
                                          return false;
                                        },
