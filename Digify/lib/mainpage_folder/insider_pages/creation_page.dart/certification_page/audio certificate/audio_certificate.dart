import 'package:digify/mainpage_folder/insider_pages/creation_page.dart/certification_page/audio certificate/working_audiocertificate.dart';
      ...
      body: SingleChildScrollView(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              const Text(
                'Record and certify audio testimonials',
                style: TextStyle(
                  fontSize: 24,
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    Icon(Icons.videocam, color: Colors.white.withOpacity(0.5)),
                ...
                child: ElevatedButton(
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => const WorkingAudioCertificate(),
                      ),
                    );
                  },
